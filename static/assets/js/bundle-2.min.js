            ...
            function lt(n, t, r) {
                ...
                return (
                    ...
                    ((u = r.getPropertyValue(t) || r[t]),
                        "" !== u || i.contains(n.ownerDocument, n) || (u = i.style(n, t)), !f.pixelMarginRight() && li.test(u) && su.test(t) && ((o = e.width), (s = e.minWidth), (h = e.maxWidth), (e.minWidth = e.maxWidth = e.width = u), (u = r.width), (e.width = o), (e.minWidth = s), (e.maxWidth = h))),
                    void 0 !== u ? u + "" : u
                );
            }
                        ...
                        this.each(function() {
                            ...
                            if ("string" === u)
                                for (e = 0, f = i(this), o = n.match(h) || [];
                                    (t = o[e++]);) f.hasClass(t) ? f.removeClass(t) : f.addClass(t);
                    ...
                    offset: function(n) {
                        ...
                        if (t)
                            return t.getClientRects().length ?
                                ((f = t.getBoundingClientRect()), (r = t.ownerDocument), (u = r.documentElement), (e = r.defaultView), { top: f.top + e.pageYOffset - u.clientTop, left: f.left + e.pageXOffset - u.clientLeft }) : { top: 0, left: 0 };
                    },
                    position: function() {
                        if (this[0]) {
                            var t,
                            ...
                            return (
                                ...
                                ((t = this.offsetParent()), (r = this.offset()), l(t[0], "html") || (n = t.offset()), (n = { top: n.top + i.css(t[0], "borderTopWidth", !0), left: n.left + i.css(t[0], "borderLeftWidth", !0) })), { top: r.top - n.top - i.css(u, "marginTop", !0), left: r.left - n.left - i.css(u, "marginLeft", !0) }
                            );
                        }
                    },
...
(function(n) {
    ...
    function t() {
        ...
        for (var t in n)
            if (i.style[t] !== undefined) return { end: n[t] };
        return !1;
    }
...
(function(n) {
    ...
    t.prototype.leave = function(t) {
        ...
        if (
            (i || ((i = new this.constructor(t.currentTarget, this.getDelegateOptions())), n(t.currentTarget).data("bs." + this.type, i)),
                t instanceof n.Event && (i.inState[t.type == "focusout" ? "focus" : "hover"] = !1), !i.isInStateTrue())
        ) {
    ...
    t.prototype.getCalculatedOffset = function(n, t, i, r) {
        return n == "bottom" ? { top: t.top + t.height, left: t.left + t.width / 2 - i / 2 } :
            n == "top" ? { top: t.top - r, left: t.left + t.width / 2 - i / 2 } :
            n == "left" ? { top: t.top + t.height / 2 - r / 2, left: t.left - i } : { top: t.top + t.height / 2 - r / 2, left: t.left + t.width };
    };
...
//         n.preventDefault();
//         alert("Mobel - Furniture Website Template \nCopyright © 2018 ElaThemes");
//     });
// });
...
function loadJs() {
    ...
    i = $("nav");
    $(document).scrollTop() > 94 && i.removeClass("navbar-sticked");
    $(document).on("bind ready scroll", function() {
        var n = $(document).scrollTop();
        n >= 160 ? i.addClass("navbar-sticked navbar-fixed") : i.removeClass("navbar-sticked navbar-fixed");
        n < 160 ? i.addClass('NavpositionRelative') : i.removeClass('NavpositionRelative');
    });
    ...
    $.each($(".owl-slider"), function(n, i) {
        ...
        $(i).owlCarousel({ autoHeight: !1, navigation: !0, navigationText: t, items: 1, singleItem: !0, addClassActive: !0, transitionStyle: "fadeUp", afterMove: r, autoPlay: 8e3, stopOnHover: !1 });
        r();
    ...
    $.each($(".owl-product-gallery"), function(n, i) {
        $(i).owlCarousel({ autoHeight: !0, slideSpeed: 800, navigation: !0, navigationText: t, pagination: !0, items: 1, singleItem: !0 });
    });
    g = $(".wrapper");
    ...
    $.each($(".product-colors"), function() {
        ...
        n.on("click", function() {
            ...
            $(this).parent().find(n).next('input[type="radio"]').attr("checked", false);
            $(this).next('input[type="radio"]').attr("checked", true);
        });

        var nc = $(".color-btn-custom");
        nc.on("click", function() {
            $(this).parent().find(nc).removeClass("checked");
            $(this).addClass("checked");
            $(this).parent().find(nc).next('input[type="radio"]').attr("checked", false);
            $(this).next('input[type="radio"]').attr("checked", true);
        });
    });
